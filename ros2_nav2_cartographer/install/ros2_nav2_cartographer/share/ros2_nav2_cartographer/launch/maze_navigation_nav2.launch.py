...
def generate_launch_description():
    ...
    param_dir = os.path.join(get_package_share_directory('ros2_nav2_cartographer'),'param')
    rviz_dir = os.path.join(get_package_share_directory('ros2_nav2_cartographer'),'rviz')

    map_file = os.path.join(config_dir,'maze_map.yaml')
    params_file = os.path.join(param_dir,'tb3_nav_params.yaml')
    rviz_config= os.path.join(rviz_dir,'tb3_navigation2.rviz')
